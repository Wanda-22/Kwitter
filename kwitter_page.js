...
//Start code
      ...
      name_with_tag = "<h4> "+ na+"<img class='user_tick' src='tick.png'>";
      message_with_tag = "<h4 class='message_h4'>" + me + "</h4>";
      span_with_tag = "<span class='glyphicon glyphicon-thumbs-up'>Like: "+ li +"</span></button><hr>";
      like_button ="<button class='btn btn-warning' id="+firebase_message_id+" value="+li+" onclick='updateLike(this.id)'>";
